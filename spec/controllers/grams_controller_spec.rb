...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "shold allow a user to destroy grams" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      delete :destroy, params: { id: gram.id} 
  ...
  describe "grams#update action" do
    ...
    it "should have the http 404 error if the gram connot be found" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    it "shouldn't let a user who did not create the gram edit a gram"
        gram = FactoryBot.create(:gram)
        user = FactoryBot.create(:user)
        sign_in user
    ...
    it "should return 404 error message if the gram is found" do
      user = FactoryBot.create(:user)
      sign_in user
